...
class _ExportScreenState extends State<ExportScreen> {
  ...
  List<Widget> _buildFormatButtons() {
    return ['mp3', 'wav', 'flac'].map<Widget>((f) => Expanded(
      child: Padding(
  ...
  List<Widget> _buildBitrateButtons() {
    return ['128k', '192k', '256k', '320k'].map<Widget>((b) => Expanded(
      child: Padding(
              ...
              child: Column(
                ...
                children: [
                  BksCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(children: _buildFormatButtons()),
                  ])),
                  const SizedBox(height: 10),
                  if (_format == 'mp3')
                    BksCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      const SectionLabel(text: 'BITRATE'),
                      Row(children: _buildBitrateButtons()),
                    ])),
                  const SizedBox(height: 10),
                  BksCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  BksCard(child: Column(children: [
                    ...
                    _toggle('📦 Stems ZIP', 'Сите стемови одвоено', _stems,
                        (v) => setState(() => _stems = v)),
                    _toggle('🎹 Ketron фајл', 'Стерео MP3 320kbps за клавијатури', _ketron,
                        (v) => setState(() => _ketron = v)),
                  ])),
                  ...
                  if (_results.isNotEmpty) ...[
                    ...
                    ..._results.entries.map<Widget>((e) => Container(
